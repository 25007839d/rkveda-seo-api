-- RKVeda SEO Intelligence v3.6
-- Competitor Intelligence CRUD + gap/opportunity foundation.
-- Existing v3.2 tables remain compatible; no destructive changes.
-- Runtime bootstrap in competitor.controller.js is also idempotent.
